    ...
    <div class="py-12 flex justify-center items-center bg-gray-900">
        <div class="max-w-full w-full mx-auto sm:px-6 lg:px-8">
            <div class="relative overflow-x-auto">
                ...
                <form action="{{ route('agregar.medicamento') }}" method="POST" class="max-w-2xl mx-auto bg-gray-700 rounded-lg px-8 pt-6 pb-8 mb-4">
                    @csrf
    
                    <div class="relative z-0 w-full mb-5 group">
                        <label for="nombre" class="block text-gray-300 text-sm font-bold mb-2">Nombre del medicamento:</label>
                        <input type="text" name="nombre" id="nombre" class="form-input mt-1 w-full bg-gray-800 text-white">
                    </div>
    
                    <div class="relative z-0 w-full mb-5 group">
                        <label for="descripcion" class="block text-gray-300 text-sm font-bold mb-2">Descripción:</label>
                        <textarea name="descripcion" id="descripcion" class="form-input mt-1 w-full bg-gray-800 text-white"></textarea>
                    </div>
    
                    <div class="relative z-0 w-full mb-5 group">
                        <label for="precio" class="block text-gray-300 text-sm font-bold mb-2">Precio:</label>
                        <input type="number" name="precio" id="precio" class="form-input mt-1 w-full bg-gray-800 text-white">
                    </div>
    
                    <div class="relative z-0 w-full mb-5 group">
                        <label for="fecha_caducidad" class="block text-gray-300 text-sm font-bold mb-2">Fecha de caducidad:</label>
                        <input type="date" name="fecha_caducidad" id="fecha_caducidad" class="form-input mt-1 w-full bg-gray-800 text-white">
                    </div>
    
                    <div class="relative z-0 w-full mb-5 group">
                        <label for="cantidad" class="block text-gray-300 text-sm font-bold mb-2">Cantidad del producto:</label>
                        <input type="number" name="cantidad" id="cantidad" class="form-input mt-1 w-full bg-gray-800 text-white">
                    </div>
                    ...
                    <button type="submit" class="bg-blue-700 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded">Agregar medicamento</button>
                </form>
            </div>
        </div>
    </div>
