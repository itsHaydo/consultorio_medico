                    ...
                    <tbody>
                        @foreach ($consultas as $item)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('doctor.realizarcita', $item->id) }}" class="text-blue-600 hover:text-blue-900 dark:text-blue-400">Realizar cita</a> |
                                    <a href="" class="text-blue-600 hover:text-blue-900 dark:text-blue-400">Editar cita</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
